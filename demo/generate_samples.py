...
def generate_excel_sample(root: str) -> list:
    ...
    workbook.properties.creator = 'SQLExternalFileDetector demo'
    workbook.properties.lastModifiedBy = 'SQLExternalFileDetector demo'
    workbook.save(path)
    _normalise_zip(path)
    return [path]
...
def generate_delta_table(root: str) -> list:
    ...
    actions = [
        ...
        {'metaData': {
            ...
            'name': 'events_delta',
            'description': 'Demo Delta table for SQLExternalFileDetector',
...
def build_collation_script() -> str:
    ...
    lines = [
        '-- ============================================================',
        '-- SQLExternalFileDetector demo: encoding vs. collation',
        '-- ------------------------------------------------------------',
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(
        description='Generate the deterministic SQLExternalFileDetector '
                    'demo samples.')
